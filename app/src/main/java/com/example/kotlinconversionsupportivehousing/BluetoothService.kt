...
//
//        Log.i("BluetoothService","Service of Bluetooth")
...
//                        Log.i("Bluetooth Device Check Service", devices[i].toString())
//                        if (devices[i] != null && devices[i].toString()
//                                .equals("53:17:E8:84:D2:76")
//                        ) {
//                            device = devices[i]
